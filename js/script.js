(function($){
	...
	$("body").queryLoader2({
		...
		if ($('#contact_form').length){
			...
			var cf = $('#contact_form');
			cf.append('<div class="message_container" style="transform: translateY(50%)"></div>');
            cf.append('<input id="subject_temp" type="text" name="cf_subject" style="position: fixed; visibility: hidden">');
            cf.append('<input id="practice_temp" type="text" name="cf_practice" style="position: fixed; visibility: hidden">');
            $(".subject_option li").click(function() {
                // console.log("Clicked");
                $("#subject_temp").val($(this).text());
            })
            $(".practice_option li").click(function() {
                // console.log("Clicked");
                $("#practice_temp").val($(this).text());
            })
		...
		if ($('#contact_form2').length){
			...
			cf.append('<div class="message_container2" style="position: absolute; left: 50%; z-index: 999999; transform: translate(-50%, 0%);"></div>');
            cf.append('<input id="subject_temp" type="text" name="cf_subject" style="position: fixed; visibility: hidden">');
            cf.append('<input id="practice_temp" type="text" name="cf_practice" style="position: fixed; visibility: hidden">');
            $(".subject_option li").click(function() {
                // console.log("Clicked");
		...
		if ($('#googleMap').length) {
			...
			$(document).ready(function() {
				...
				var myCenter = new google.maps.LatLng(-33.944360, 18.490098);
				...
				function loadMap() {
		            ...
		            var marker = new google.maps.Marker({
		               position:myCenter,
		               map: map,
									 icon: 'images/hospital-place.png',
		            });
